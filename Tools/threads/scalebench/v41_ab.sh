#!/usr/bin/env bash
# §37 flat-gap-bughunter round 3 measurement driver.
# Round-3 worktree (R-addproptransition-concurrently-unconditional-mlo DCLP
# precheck + go-gap-liveheap tf-scratch + flatten1 in-place mutate + post-
# flatten1 fullGC + cs1 pre-warm + ingestWriterHold geometric-grow). 3-rep
# medians, GIL-off pinned env.
set -u
...
RAW="$SB/results-v41ab-raw.jsonl"
: > "$RAW"
ulimit -c 0
