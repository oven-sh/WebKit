#!/usr/bin/env python3
"""§43 iso-TLC-slot + thin-thunk analyzer: medians + checksum + RSS from results-v43ab-raw.jsonl."""
import json, statistics as st, sys, os

SB = os.path.dirname(os.path.abspath(__file__))
RAW = sys.argv[1] if len(sys.argv) > 1 else os.path.join(SB, "results-v43ab-raw.jsonl")
...
REF = {
    ...
    "default": ("b3e65a6855b9bdeb", 4158957, "39c33392b2a4c5b2", "c4bdd580f85ee058", "af028188d7a56a96"),
...
print(f"# §43 raw analysis ({len(recs)} records)")
