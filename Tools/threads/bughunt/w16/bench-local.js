...
const N_BASE_SMOKE = 2000;    // LOCAL COPY: stock smoke size
...
// LOCAL COPY: optional 3rd arg overrides N_BASE for the ASAN crash sweep:
//   jsc <flags> bench-local.js -- W smoke <N>
const N_OVERRIDE = (shellArgs.length > 2) ? parseInt(shellArgs[2], 10) : NaN;
const N_BASE = (N_OVERRIDE >= 1) ? N_OVERRIDE : (isSmoke() ? N_BASE_SMOKE : N_BASE_DEFAULT);
