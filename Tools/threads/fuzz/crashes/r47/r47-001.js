...
// EXIT: 134
// SOURCE: /root/WebKit/WebKitBuild/Fuzz/fuzzilli-storage-r47/crashes/program_20260619094908_B32B8980-4F5C-4357-AF8C-3AE801ED6DDD_deterministic.js
// ==================
...
function f5(a6) {
    explore("v46", a6, this, [Uint8Array, a6, f5, 3105, Thread], 6);
...
// 
// STDOUT:
// EXPLORE_ACTION: {"operation":"SET_PROPERTY","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"d"}},{"argument":{"index":2}}],"isGuarded":false,"id":"v24"}
// EXPLORE_ACTION: {"operation":"BITWISE_NOT","inputs":[{"special":{"name":"exploredValue"}}],"isGuarded":false,"id":"v26"}
// EXPLORE_ACTION: {"operation":"BITWISE_NOT","inputs":[{"special":{"name":"exploredValue"}}],"isGuarded":false,"id":"v27"}
// EXPLORE_ACTION: {"operation":"CALL_METHOD","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"from"}},{"argument":{"index":3}}],"isGuarded":true,"id":"v28"}
// EXPLORE_ACTION: {"operation":"GET_PROPERTY","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"arguments"}}],"isGuarded":false,"id":"v31"}
// EXPLORE_ACTION: {"operation":"CALL_METHOD","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"localeCompare"}},{"argument":{"index":2}}],"isGuarded":true,"id":"v34"}
// EXPLORE_ACTION: {"operation":"SIGNED_RIGHT_SHIFT","inputs":[{"special":{"name":"exploredValue"}},{"int":{"value":12}}],"isGuarded":false,"id":"v39"}
// EXPLORE_ACTION: {"operation":"CALL_METHOD","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"apply"}},{"argument":{"index":2}},{"argument":{"index":2}}],"isGuarded":true,"id":"v56"}
// EXPLORE_ACTION: {"operation":"CONSTRUCT_METHOD","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"constructor"}},{"argument":{"index":1}}],"isGuarded":true,"id":"v51"}
// EXPLORE_ACTION: {"operation":"SUB","inputs":[{"special":{"name":"exploredValue"}},{"argument":{"index":0}}],"isGuarded":false,"id":"v52"}
