...
using JSInstruction = BaseInstruction<JSOpcodeTraits>;
    ...
    public:
        ...
        CodeBlock** addressOfCodeBlock() const { return __bit_cast<CodeBlock**>(this + static_cast<int>(CallFrameSlot::codeBlock)); }
    ...
    public:
        ...
        JSValue* addressOfArgumentsStart() const { return __bit_cast<JSValue*>(this + argumentOffset(0)); }
...
#define DECLARE_CALL_FRAME(vm) \
    ({ \
        ...
        __bit_cast<JSC::CallFrame*>(*((uintptr_t**) _AddressOfReturnAddress() - 1)); \
    })
#else // !OS(WINDOWS)
...
#define DECLARE_CALL_FRAME(vm) \
    ({ \
        ASSERT(JSC::isFromJSCode(removeCodePtrTag<void*>(__builtin_return_address(0)))); \
        __bit_cast<JSC::CallFrame*>(__builtin_frame_address(1)); \
    })
#endif // !OS(WINDOWS)
#else
