...
set(USE_BUN_FAST_TLS OFF)

WEBKIT_OPTION_BEGIN()
WEBKIT_OPTION_DEFINE(BUN_FAST_TLS "Enable fast TLS without Apple SPI" PUBLIC OFF)
if (BUN_FAST_TLS)
    set(USE_BUN_FAST_TLS ON)
    SET_AND_EXPOSE_TO_BUILD(USE_BUN_FAST_TLS 1)
    SET_AND_EXPOSE_TO_BUILD(BUN_FAST_TLS 1) 
    SET_AND_EXPOSE_TO_BUILD(HAVE_FAST_TLS 1) 
endif ()
