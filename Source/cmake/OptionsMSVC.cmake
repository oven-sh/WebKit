...
# Detect the correct architecture for clang runtime library
if(CMAKE_SYSTEM_PROCESSOR MATCHES "ARM64|aarch64")
    set(CLANG_RT_ARCH "aarch64")
elseif(CMAKE_SYSTEM_PROCESSOR MATCHES "AMD64|x86_64")
    set(CLANG_RT_ARCH "x86_64")
else()
    set(CLANG_RT_ARCH "x86_64")  # Default fallback
endif()

find_library(CLANG_BUILTINS_LIBRARY clang_rt.builtins-${CLANG_RT_ARCH} PATHS ${CLANG_CL_DIR} REQUIRED NO_DEFAULT_PATH)
