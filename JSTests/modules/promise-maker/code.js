...
export function asyncThatThrows() { const promise = (async () => { throw error(); })(); return promise; }
...
export function any(promise) { const derived = Promise.any([promise]); return derived; }
...
export function pending() { const made = Promise.withResolvers(); return made.promise; }
