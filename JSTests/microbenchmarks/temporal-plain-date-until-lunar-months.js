...
// years in the calendars whose months follow the moon. The month count comes from the epoch-day
// span, confirmed by one ICU month add, so the cost of a difference does not grow with the span;
// probing one candidate month at a time made a century of chinese months cost about a second.

const cases = [];
for (const calendar of ["chinese", "dangi", "hebrew", "islamic-umalqura"]) {
