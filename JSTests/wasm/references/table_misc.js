...

{
    ...
    assert.throws(() => $1.exports.tbl_fill(20,null,1), Error, "Out of bounds table access")
    assert.throws(() => $1.exports.tbl_fill(19,null,2), Error, "Out of bounds table access")
    assert.throws(() => $1.exports.tbl_fill(4294967295,null,1), Error, "Out of bounds table access")
}
