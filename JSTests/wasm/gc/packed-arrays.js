...
*/
    assert.throws(() => new WebAssembly.Instance(module("")),
                  WebAssembly.CompileError,
                  "WebAssembly.Module doesn't parse at byte 15: can't get type index for array.get_s, in function at index 0");
/*
(module
   (type (array (mut i8)))
   (func (export "f") (result i32)
...
*/
    assert.throws(() => new WebAssembly.Instance(module("")),
                  WebAssembly.CompileError,
                  "WebAssembly.Module doesn't parse at byte 15: can't get type index for array.get_u, in function at index 0");
}
