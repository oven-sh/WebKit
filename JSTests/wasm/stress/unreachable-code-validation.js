...
invalid(`(module (func unreachable (i64.const 1) i32.add drop))`, "in unreachable code");
...
// References. A bottom operand is a valid reference operand, and ref.as_non_null of it is still a reference.
invalid(`(module (func unreachable (ref.is_null (i32.const 0)) drop))`);
invalid(`(module (func unreachable ref.as_non_null i32.eqz drop))`);
