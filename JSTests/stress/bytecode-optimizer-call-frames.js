...
function narrow(arr) { return wide.apply(null, arr); } // tail call with more arguments than the caller received
function outer(v) { const keep = { v }; const r = narrow([v, v + 1, v + 2, v + 3, v + 4, v + 5, v + 6]); return keep.v + ":" + r; }
shouldBe(outer(10), "10:10,11,12,13,14,15,16", "tail_call_varargs growing the frame");
function spreadCall(...args) { return wide(...args, "x", "y", "z"); }
shouldBe(spreadCall(1, 2, 3, 4), "1,2,3,4,x,y,z", "spread call");
