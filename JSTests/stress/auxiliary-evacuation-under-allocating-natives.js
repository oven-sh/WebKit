//@ runDefault("--evacuateAuxiliaryBlocksAfterEveryFullCollection=1", "--slowPathAllocsBetweenGCs=7", "--useConcurrentGC=0")
//@ runDefault("--evacuateAuxiliaryBlocksAfterEveryFullCollection=1", "--slowPathAllocsBetweenGCs=3", "--useJIT=0")
