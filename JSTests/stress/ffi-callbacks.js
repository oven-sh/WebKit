...
function main() {
    ...
    // ---- A throwing callback: the exception (with its JS stack) surfaces at the FFI call site.
    {
        ...
        if (typeof caught.stack !== "string" || caught.stack.indexOf("throwingCallback") === -1)
            throw new Error("expected the JS stack of the callback frame in the exception, got: " + caught.stack);
